...
/* invoices/index.twig */
class __TwigTemplate_09e317d8ab986f78d909c1ee9402b9b1 extends Template
{
...
<table>
    ...
    <tbody>
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["invoice"]) {
            ...
            yield "            <tr>
                <td>";
            // line 44
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["invoice"], "invoice_number", [], "any", false, false, false, 44), "html", null, true);
            yield "</td>
                <td>\$";
            // line 45
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["invoice"], "amount", [], "any", false, false, false, 45), "html", null, true);
            yield "</td>
                <td>";
            // line 46
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["invoice"], "status", [], "any", false, false, false, 46), "html", null, true);
            yield "</td>
                <td>";
            // line 47
    ...
    {
        return array (  120 => 52,  113 => 50,  105 => 47,  101 => 46,  97 => 45,  93 => 44,  90 => 43,  85 => 42,  42 => 1,);
    }
